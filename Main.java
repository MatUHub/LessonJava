public class Main {
    ...
    public static void main(String[] args) {
        ...
        Object roundHoleAdapter = new Object();
    ...
    public class RoundHoleAdapter extends DefaultRoundHole {

        public RoundHoleAdapter(double radius) {
            super(radius);
    ...
    interface SquareHole {
        double side();
    }

    static class DefaultSquareHole implements SquareHole {
        private final double side;
        public DefaultSquareHole(double side) {
            this.side = side;
        }
        @Override
        public double side() {
